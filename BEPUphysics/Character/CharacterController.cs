...
using OpenTK.BEPUphysics.Entities.Prefabs;
...
namespace OpenTK.BEPUphysics.Character
{
    /// <summary>
    ...
    public class CharacterController : Updateable, IBeforeSolverUpdateable
    {
        ...
        public Vector3 Down
        {
            get
            {
                return Body.OrientationMatrix4.Down;
            }
            set
            {
                ...
                if (lengthSquared < Toolbox.Epsilon)
                    value = Body.OrientationMatrix4.Down; //Silently fail. Assuming here that a dynamic process is setting this property; don't need to make a stink about it.
                else
        ...
        void CorrectContacts()
        {
            ...
            Vector3 downDirection = Body.OrientationMatrix4.Down;
