...
namespace OpenTK.BEPUphysics.Character
{
    ...
    public class HorizontalMotionConstraint : SolverUpdateable
    {
        ...
        {
            Vector3 down = characterBody.orientationMatrix4.Down;
            ...
            if (forwardLengthSquared < Toolbox.Epsilon)
            {
                ...
                horizontalForwardDirection = characterBody.orientationMatrix4.Forward;
                strafeDirection = characterBody.orientationMatrix4.Right;
            }
            else
            {
        ...
        public override float SolveIteration()
        {
            ...
            Matrix2.Transform(ref lambda, ref massMatrix4, out lambda);
