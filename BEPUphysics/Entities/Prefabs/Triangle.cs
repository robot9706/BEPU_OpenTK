...
namespace OpenTK.BEPUphysics.Entities.Prefabs
{
    /// <summary>
    ...
    public class Triangle : Entity<ConvexCollidable<TriangleShape>>
    {
        ...
        public Vector3 VertexA
        {
            get
            {
                return Matrix3x3.Transform(CollisionInformation.Shape.VertexA, orientationMatrix4) + position;
            }
            set
            {
                CollisionInformation.Shape.VertexA = Matrix3x3.TransformTranspose(value - position, orientationMatrix4);
            }
        }
        ///<summary>
        ...
        public Vector3 VertexB
        {
            get
            {
                return Matrix3x3.Transform(CollisionInformation.Shape.VertexB, orientationMatrix4) + position;
            }
            set
            {
                CollisionInformation.Shape.VertexB = Matrix3x3.TransformTranspose(value - position, orientationMatrix4);
            }
        }
        ///<summary>
        ...
        public Vector3 VertexC
        {
            get
            {
                return Matrix3x3.Transform(CollisionInformation.Shape.VertexC, orientationMatrix4) + position;
            }
            set
            {
                CollisionInformation.Shape.VertexC = Matrix3x3.TransformTranspose(value - position, orientationMatrix4);
            }
        }
