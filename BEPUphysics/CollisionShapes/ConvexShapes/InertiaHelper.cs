...
namespace OpenTK.BEPUphysics.CollisionShapes.ConvexShapes
{
    ///<summary>
    ...
    public static class InertiaHelper
    {
        ...
        public static void ComputeShapeDistribution(IList<Vector3> vertices, IList<int> triangleIndices, out float volume, out Matrix3x3 volumeDistribution)
        {
            ...
            //Looking to find inertia tensor Matrix4 of the form
            // [  a  -b' -c' ]
            // [ -b'  b  -a' ]
            // [ -c' -a'  c  ]
        ...
        public static void ComputeShapeDistribution(IList<Vector3> vertices, IList<int> triangleIndices, out Vector3 center, out float volume, out Matrix3x3 volumeDistribution)
        {
            ...
            if (scaledVolume < Toolbox.Epsilon)
            {
                ...
                //If the mass is zero, then a zero Matrix4 is the consistent result.
            ...
            else
            {
                ...
                //So, each term of the Matrix4 (like M11 = sum(mi * (ry*ry + rz*rz))) can be rephrased in terms of the center and the offset:
                ...
                //With a little more massaging, the constant c terms can be fully separated into an additive term on each Matrix4 element.
            }
