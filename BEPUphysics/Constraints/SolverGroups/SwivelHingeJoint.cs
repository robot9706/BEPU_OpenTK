using OpenTK.BEPUphysics.Constraints.TwoEntity;
using OpenTK.BEPUphysics.Constraints.TwoEntity.JointLimits;
using OpenTK.BEPUphysics.Constraints.TwoEntity.Joints;
using OpenTK.BEPUphysics.Constraints.TwoEntity.Motors;
using OpenTK.BEPUphysics.Entities;
using OpenTK.BEPUutilities;
 

namespace OpenTK.BEPUphysics.Constraints.SolverGroups
{
    /// <summary>
    ...
    public class SwivelHingeJoint : SolverGroup
    {
        ...
        public SwivelHingeJoint(Entity connectionA, Entity connectionB, Vector3 anchor, Vector3 hingeAxis)
        {
            ...
            HingeLimit.Basis.SetWorldAxes(hingeAxis, baseAxis, connectionA.orientationMatrix4);
            HingeMotor.Basis.SetWorldAxes(hingeAxis, baseAxis, connectionA.orientationMatrix4);
