using System;
using OpenTK.BEPUphysics.Constraints.TwoEntity.Motors;
using OpenTK.BEPUphysics.Entities;
using OpenTK.BEPUutilities;
 

namespace OpenTK.BEPUphysics.Constraints.SingleEntity
{
    /// <summary>
    ...
    public class SingleEntityLinearMotor : SingleEntityConstraint, I3DImpulseConstraintWithError
    {
        ...
        private Matrix3x3 effectiveMassMatrix4;
        ...
        public Vector3 LocalPoint
        {
            ...
            {
                localPoint = value;
                Matrix3x3.Transform(ref localPoint, ref entity.orientationMatrix4, out worldPoint);
        ...
        public Vector3 Point
        {
            ...
            set
            {
                ...
                Matrix3x3.TransformTranspose(ref localPoint, ref entity.orientationMatrix4, out localPoint);
            }
        }
        ...
        public override float SolveIteration()
        {
            ...
            Matrix3x3.Transform(ref lambda, ref effectiveMassMatrix4, out lambda);
        ...
        public override void Update(float dt)
        {
            ...
            Matrix3x3.Transform(ref localPoint, ref entity.orientationMatrix4, out r);
            ...
            Matrix3x3.Subtract(ref linearComponent, ref angularComponentA, out effectiveMassMatrix4);
