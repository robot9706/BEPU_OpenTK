...
namespace OpenTK.BEPUphysics.Constraints.TwoEntity.JointLimits
{
    ...
    public class DistanceLimit : JointLimit, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public Vector3 LocalAnchorA
        {
            ...
            {
                localAnchorA = value;
                Matrix3x3.Transform(ref localAnchorA, ref connectionA.orientationMatrix4, out anchorA);
        ...
        public Vector3 LocalAnchorB
        {
            ...
            {
                localAnchorB = value;
                Matrix3x3.Transform(ref localAnchorB, ref connectionB.orientationMatrix4, out anchorB);
        ...
        {
            outputMassMatrix4 = velocityToImpulse;
        }
        ...
        public override void Update(float dt)
        {
            ...
            Matrix3x3.Transform(ref localAnchorA, ref connectionA.orientationMatrix4, out offsetA);
            Matrix3x3.Transform(ref localAnchorB, ref connectionB.orientationMatrix4, out offsetB);
            ...
            if (distance > maximumLength)
            {
                ...
                //Still need to negate angular A.  It's done after the effective mass Matrix4.
            ...
            //Compute effective mass Matrix4
            ...
            //Finish computing jacobian; it's down here as an optimization (since it didn't need to be negated in mass Matrix4)
