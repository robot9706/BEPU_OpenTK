    ...
    public class EllipseSwingLimit : JointLimit, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public Vector3 LocalTwistAxisB
        {
            ...
            set
            {
                ...
                Matrix3x3.Transform(ref localTwistAxisB, ref connectionB.orientationMatrix4, out worldTwistAxisB);
            }
        }
        ...
        public Vector3 TwistAxisB
        {
            ...
            set
            {
                ...
                Matrix3x3.TransformTranspose(ref worldTwistAxisB, ref connectionB.orientationMatrix4, out localTwistAxisB);
            }
        }
