...
namespace OpenTK.BEPUphysics.Constraints.TwoEntity.JointLimits
{
    ...
    public class RevoluteLimit : JointLimit, I2DImpulseConstraintWithError, I2DJacobianConstraint
    {
        ...
        public RevoluteLimit(Entity connectionA, Entity connectionB, Vector3 limitedAxis, Vector3 testAxis, float minimumAngle, float maximumAngle)
        {
            ...
            basis.rotationMatrix4 = this.connectionA.orientationMatrix4;
        ...
        public Vector3 TestAxis
        {
            ...
            set
            {
                ...
                Matrix3x3.TransformTranspose(ref worldTestAxis, ref connectionB.orientationMatrix4, out localTestAxis);
            }
        }
        ...
        /// <summary>
        /// Gets the mass Matrix4 of the revolute limit.
        /// The revolute limit is special; in terms of solving, it is
        /// actually sometimes TWO constraints; a minimum plane, and a
        /// maximum plane.  The M11 field represents the minimum plane mass Matrix4
        /// and the M22 field represents the maximum plane mass Matrix4.
        /// </summary>
        /// <param name="massMatrix4">Mass Matrix4 of the constraint.</param>
        public void GetMassMatrix4(out Matrix2 massMatrix4)
        {
            massMatrix4.M11 = velocityToImpulse.X;
            massMatrix4.M22 = velocityToImpulse.Y;
            massMatrix4.M12 = 0;
            massMatrix4.M21 = 0;
        }
