...
namespace OpenTK.BEPUphysics.Constraints.TwoEntity.Motors
{
    /// <summary>
    ...
    public class LinearAxisMotor : Motor, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public Vector3 AnchorA
        {
            ...
            set
            {
                ...
                Matrix3x3.TransformTranspose(ref worldOffsetA, ref connectionA.orientationMatrix4, out localAnchorA);
            }
        }
        ...
        public Vector3 AnchorB
        {
            ...
            set
            {
                ...
                Matrix3x3.TransformTranspose(ref worldOffsetB, ref connectionB.orientationMatrix4, out localAnchorB);
            }
        }
        ...
        public Vector3 Axis
        {
            ...
            set
            {
                ...
                Matrix3x3.TransformTranspose(ref worldAxis, ref connectionA.orientationMatrix4, out localAxis);
            }
        }
        ...
        public Vector3 LocalAxis
        {
            ...
            set
            {
                ...
                Matrix3x3.Transform(ref localAxis, ref connectionA.orientationMatrix4, out worldAxis);
            }
        }
        ...
        public Vector3 LocalOffsetA
        {
            ...
            {
                localAnchorA = value;
                Matrix3x3.Transform(ref localAnchorA, ref connectionA.orientationMatrix4, out worldOffsetA);
        ...
        public Vector3 LocalOffsetB
        {
            ...
            {
                localAnchorB = value;
                Matrix3x3.Transform(ref localAnchorB, ref connectionB.orientationMatrix4, out worldOffsetB);
        ...
        public Vector3 OffsetA
        {
            ...
            set
            {
                worldOffsetA = value;
                worldAnchorA = connectionA.position + worldOffsetA;
                Matrix3x3.TransformTranspose(ref worldOffsetA, ref connectionA.orientationMatrix4, out localAnchorA); //Looks weird, but localAnchorA is "localOffsetA."
        ...
        public Vector3 OffsetB
        {
            ...
            set
            {
                worldOffsetB = value;
                worldAnchorB = connectionB.position + worldOffsetB;
                Matrix3x3.TransformTranspose(ref worldOffsetB, ref connectionB.orientationMatrix4, out localAnchorB);//Looks weird, but localAnchorB is "localOffsetB."
            }
        }
        ...
        /// </summary>
        /// <param name="outputMassMatrix4">Constraint's mass Matrix4.</param>
        public void GetMassMatrix4(out float outputMassMatrix4)
        {
            outputMassMatrix4 = massMatrix4;
        }
        ...
        public override void Update(float dt)
        {
            ...
            if (connectionB.isDynamic)
            {
                ...
                entryB = 0;
            massMatrix4 = 1 / (entryA + entryB + usedSoftness);
