    ...
    public class SwivelHingeAngularJoint : Joint, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public Vector3 LocalHingeAxis
        {
            ...
            set
            {
                ...
                Matrix3x3.Transform(ref localHingeAxis, ref connectionA.orientationMatrix4, out worldHingeAxis);
            }
        }
        ...
        public Vector3 LocalTwistAxis
        {
            ...
            set
            {
                ...
                Matrix3x3.Transform(ref localTwistAxis, ref connectionB.orientationMatrix4, out worldTwistAxis);
            }
        }
