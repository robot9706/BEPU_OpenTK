...
namespace OpenTK.BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    public class PointOnLineJoint : Joint, I2DImpulseConstraintWithError, I2DJacobianConstraint
    {
        ...
        private Matrix2 negativeEffectiveMassMatrix4;
        ...
        public Vector3 LineAnchor
        {
            ...
            set
            {
                ...
                Matrix3x3.TransformTranspose(ref localAxisAnchor, ref connectionA.orientationMatrix4, out localAxisAnchor);
        ...
        public Vector3 LineDirection
        {
            ...
            set
            {
                ...
                Matrix3x3.TransformTranspose(ref worldLineDirection, ref connectionA.orientationMatrix4, out localLineDirection);
        ...
        public Vector3 LocalPoint
        {
            ...
            {
                localPoint = value;
                Matrix3x3.Transform(ref localPoint, ref connectionB.orientationMatrix4, out worldPoint);
        ...
        public Vector3 Point
        {
            ...
            set
            {
                ...
                Matrix3x3.TransformTranspose(ref localPoint, ref connectionB.orientationMatrix4, out localPoint);
            }
        }
        ...
        {
            Matrix2.Negate(ref negativeEffectiveMassMatrix4, out massMatrix4);
        }
        ...
        public override float SolveIteration()
        {
            ...
            //Convert to impulse
            Matrix2.Transform(ref lambda, ref negativeEffectiveMassMatrix4, out lambda);
