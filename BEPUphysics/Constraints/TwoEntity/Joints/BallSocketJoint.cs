...
namespace OpenTK.BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    public class BallSocketJoint : Joint, I3DImpulseConstraintWithError, I3DJacobianConstraint
    {
        ...
        public void GetMassMatrix4(out Matrix3x3 outputMassMatrix4)
        {
        ...
        public override void Update(float dt)
        {
            ...
            k.M22 += softness;
            k.M33 += softness;
            Matrix3x3.Invert(ref k, out massMatrix4);
        ...
        public override float SolveIteration()
        {
            ...
            Matrix3x3.Transform(ref lambda, ref massMatrix4, out lambda);
