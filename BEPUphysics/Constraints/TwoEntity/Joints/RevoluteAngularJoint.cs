using System;
using OpenTK.BEPUphysics.Entities;
using OpenTK.BEPUutilities;


namespace OpenTK.BEPUphysics.Constraints.TwoEntity.Joints
{
    /// <summary>
    ...
    public class RevoluteAngularJoint : Joint, I2DImpulseConstraintWithError, I2DJacobianConstraint
    {
        ...
        private Matrix2 effectiveMassMatrix4;
        ...
        public Vector3 LocalFreeAxisA
        {
            ...
            set
            {
                ...
                Matrix3x3.Transform(ref localAxisA, ref connectionA.orientationMatrix4, out worldAxisA);
        ...
        public Vector3 LocalFreeAxisB
        {
            ...
            set
            {
                ...
                Matrix3x3.Transform(ref localAxisB, ref connectionB.orientationMatrix4, out worldAxisB);
            }
        }
        ...
        public Vector3 WorldFreeAxisA
        {
            ...
            set
            {
                ...
                Matrix3x3.TransformTranspose(ref worldAxisA, ref connectionA.orientationMatrix4, out localAxisA);
                UpdateRestrictedAxes();
            }
        }
        ...
        public Vector3 WorldFreeAxisB
        {
            ...
            set
            {
                ...
                Matrix3x3.TransformTranspose(ref worldAxisB, ref connectionB.orientationMatrix4, out localAxisB);
            }
        }
        ...
        /// <summary>
        /// Gets the mass Matrix4 of the constraint.
        /// </summary>
        /// <param name="massMatrix4">Constraint's mass Matrix4.</param>
        public void GetMassMatrix4(out Matrix2 massMatrix4)
        {
            massMatrix4 = effectiveMassMatrix4;
        }
        ...
        public override void Update(float dt)
        {
            ...
            Matrix3x3.Transform(ref localConstrainedAxis1, ref connectionA.orientationMatrix4, out worldConstrainedAxis1);
            Matrix3x3.Transform(ref localConstrainedAxis2, ref connectionA.orientationMatrix4, out worldConstrainedAxis2);
            ...
            Vector3.Dot(ref axis1I, ref worldConstrainedAxis1, out effectiveMassMatrix4.M11);
            Vector3.Dot(ref axis1I, ref worldConstrainedAxis2, out effectiveMassMatrix4.M12);
            Vector3.Dot(ref axis2I, ref worldConstrainedAxis1, out effectiveMassMatrix4.M21);
            Vector3.Dot(ref axis2I, ref worldConstrainedAxis2, out effectiveMassMatrix4.M22);
            effectiveMassMatrix4.M11 += softness;
            effectiveMassMatrix4.M22 += softness;
            Matrix2.Invert(ref effectiveMassMatrix4, out effectiveMassMatrix4);
            Matrix2.Negate(ref effectiveMassMatrix4, out effectiveMassMatrix4);
        ...
        public override float SolveIteration()
        {
            ...
            Matrix2.Transform(ref lambda, ref effectiveMassMatrix4, out lambda);
