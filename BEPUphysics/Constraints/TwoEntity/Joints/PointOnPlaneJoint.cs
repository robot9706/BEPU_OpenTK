    ...
    public class PointOnPlaneJoint : Joint, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public Vector3 LocalPointAnchor
        {
            ...
            set
            {
                ...
                Matrix3x3.Transform(ref localPointAnchor, ref connectionB.orientationMatrix4, out worldPointAnchor);
        ...
        public Vector3 PlaneAnchor
        {
            ...
            set
            {
                ...
                Matrix3x3.TransformTranspose(ref localPlaneAnchor, ref connectionA.orientationMatrix4, out localPlaneAnchor);
        ...
        public Vector3 PlaneNormal
        {
            ...
            set
            {
                ...
                Matrix3x3.TransformTranspose(ref worldPlaneNormal, ref connectionA.orientationMatrix4, out localPlaneNormal);
            }
        }
        ...
        public Vector3 PointAnchor
        {
            ...
            set
            {
                ...
                Matrix3x3.TransformTranspose(ref localPointAnchor, ref connectionB.orientationMatrix4, out localPointAnchor);
        ...
        {
            outputMassMatrix4 = -negativeEffectiveMass;
        }
