...
using OpenTK.BEPUutilities.DataStructures;

namespace OpenTK.BEPUphysics.Constraints.Collision
{
    /// <summary>
    ...
    public class SlidingFrictionTwoAxis : SolverUpdateable
    {
        ...
        public Vector2 RelativeVelocity
        {
            get
            {
                ...
                //Explicit version:
                //Vector2 dot;
                //Matrix42x3.Transform(ref parentA.myInternalLinearVelocity, ref linearA, out lambda);
                //Matrix42x3.Transform(ref parentB.myInternalLinearVelocity, ref linearA, out dot);
                //lambda.X -= dot.X; lambda.Y -= dot.Y;
                //Matrix42x3.Transform(ref parentA.myInternalAngularVelocity, ref angularA, out dot);
                //lambda.X += dot.X; lambda.Y += dot.Y;
                //Matrix42x3.Transform(ref parentB.myInternalAngularVelocity, ref angularB, out dot);
                //lambda.X += dot.X; lambda.Y += dot.Y;
        ...
        public override float SolveIteration()
        {
            ...
            //Convert to impulse
            //Matrix42x2.Transform(ref lambda, ref velocityToImpulse, out lambda);
            float x = lambda.X;
...
#endif
            //Matrix42x3.Transform(ref lambda, ref linearA, out linear);
            ...
            if (entityADynamic)
            {
                //Matrix42x3.Transform(ref lambda, ref angularA, out angular);
            ...
            if (entityBDynamic)
            {
                ...
                linear.Y = -linear.Y;
                linear.Z = -linear.Z;
                //Matrix42x3.Transform(ref lambda, ref angularB, out angular);
        ...
        public override void Update(float dt)
        {
            ...
            //Compute inverse effective mass Matrix4
            ...
            if (entityADynamic)
            {
                ...
                Matrix2.Multiply(ref transform, ref transpose, out entryA);
            ...
            if (entityBDynamic)
            {
                ...
                Matrix2.Multiply(ref transform, ref transpose, out entryB);
