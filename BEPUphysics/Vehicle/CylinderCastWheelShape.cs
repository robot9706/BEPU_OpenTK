...
namespace OpenTK.BEPUphysics.Vehicle
{
    /// <summary>
    ...
    public class CylinderCastWheelShape : WheelShape
    {
        ...
        public CylinderCastWheelShape(float radius, float width, Quaternion localWheelOrientation, Matrix4 localGraphicTransform, bool includeSteeringTransformInCast)
        {
        ...
        public override void UpdateWorldTransform()
        {
            ...
            worldTransform = Matrix3x3.ToMatrix4X4(wheel.vehicle.Body.BufferedStates.InterpolatedStates.OrientationMatrix4);

            Matrix4.TransformNormal(ref localAttach, ref worldTransform, out worldAttachmentPoint);
            worldAttachmentPoint += wheel.vehicle.Body.BufferedStates.InterpolatedStates.Position;

            Vector3 worldDirection;
            Matrix4.Transform(ref wheel.suspension.localDirection, ref worldTransform, out worldDirection);
            ...
            Matrix4.CreateFromAxisAngle(ref localSpinAxis, spinAngle, out spinTransform);
