...
using OpenTK.BEPUphysics.UpdateableSystems;
    ...
    public class Wheel
    {
        ...
        public Vector3 LocalForwardDirection
        {
            ...
            set
            {
                ...
                if (vehicle != null)
                    Matrix3x3.Transform(ref localForwardDirection, ref Vehicle.Body.orientationMatrix4, out worldForwardDirection);
                else
        ...
        {
            Matrix4.CreateFromAxisAngle(ref suspension.localDirection, shape.steeringAngle, out shape.steeringTransform);
            Matrix4.TransformNormal(ref localForwardDirection, ref shape.steeringTransform, out worldForwardDirection);
            Matrix3x3.Transform(ref worldForwardDirection, ref Vehicle.Body.orientationMatrix4, out worldForwardDirection);
            if (HasSupport)
            {
