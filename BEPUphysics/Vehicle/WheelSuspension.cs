using OpenTK.BEPUphysics.Constraints;
...
namespace OpenTK.BEPUphysics.Vehicle
{
    ...
    public class WheelSuspension : ISpringSettings, ISolverSettings
    {
        ...
        //Inverse effective mass Matrix4
        ...
        public Vector3 LocalDirection
        {
            ...
            set
            {
                ...
                if (wheel != null)
                    wheel.shape.Initialize();
                if (wheel != null && wheel.vehicle != null)
                    Matrix3x3.Transform(ref localDirection, ref wheel.vehicle.Body.orientationMatrix4, out worldDirection);
                else
        ...
        public Vector3 WorldDirection
        {
            ...
            set
            {
                ...
                if (wheel != null)
                    wheel.shape.Initialize();
                if (wheel != null && wheel.vehicle != null)
                    Matrix3x3.TransformTranspose(ref worldDirection, ref wheel.Vehicle.Body.orientationMatrix4, out localDirection);
                else
        ...
        internal void PreStep(float dt)
        {
            ...
            //Vector3.TransformNormal(ref myLocalDirection, ref parentA.myInternalOrientationMatrix4, out myWorldDirection);
