...
namespace OpenTK.BEPUphysics.DeactivationManagement
{
    /// <summary>
    ...
    public class SimulationIslandMember
    {
        ...
        internal OpenTK.BEPUutilities.SpinLock simulationIslandChangeLocker = new OpenTK.BEPUutilities.SpinLock();
