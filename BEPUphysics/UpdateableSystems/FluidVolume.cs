...
namespace OpenTK.BEPUphysics.UpdateableSystems
{
    ...
    public class FluidVolume : Updateable, IDuringForcesUpdateable, ICollisionRulesOwner
    {
        ...
        private Matrix3x3 toSurfaceRotationMatrix4;
        Vector3 upVector;
        ///<summary>
        ...
        public void RecalculateBoundingBox()
        {
            ...
            Matrix3x3.CreateFromQuaternion(ref surfaceTransform.Orientation, out toSurfaceRotationMatrix4);
