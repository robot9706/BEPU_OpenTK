using System;
using OpenTK.BEPUphysics.Constraints.SingleEntity;
...
namespace OpenTK.BEPUphysics.Paths.PathFollowing
{
    /// <summary>
    ...
    public class EntityMover : Updateable, IDuringForcesUpdateable
    {
        ...
        void IDuringForcesUpdateable.Update(float dt)
        {
            ...
            else
            {
                ...
                Vector3 worldMovedPoint = Matrix3x3.Transform(LocalOffset, entity.orientationMatrix4);
